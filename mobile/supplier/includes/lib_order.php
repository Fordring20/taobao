...
function order_goods($order_id)
{
	$sql = "SELECT rec_id, og.goods_id, og.goods_name, g.goods_thumb, og.goods_sn, og.market_price, og.goods_number, " .
            ...
            " WHERE order_id = '$order_id'";// 修改 by www.ahxcjy.com 增加 package_attr_id 字段
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        {
            $row['package_goods_list'] = get_package_goods($row['goods_id'], $row['package_attr_id']); // 修改 by www.ahxcjy.com
        }
        $goods_list[] = $row;
    }
...
$sql_where = $_SESSION['user_id']>0 ? "c.user_id='". $_SESSION['user_id'] ."' " : "c.session_id = '" . SESS_ID . "' AND c.user_id=0 ";
    ...
    foreach ($arr as $key => $value)
    {
        ...
        {
            $arr[$key]['package_goods_list'] = get_package_goods($value['goods_id'], $value['package_attr_id']); //修改 by www.ahxcjy.com
        }
    }
...
function addto_cart($goods_id, $num = 1, $spec = array(), $parent = 0)
{
    ...
    $parent = array(
		...
		'add_time'   => gmtime(),   //代码增加   By  bbs.ahxcjy.com
    ...
    if ($num > 0)
    {
        ...
        $sql = "SELECT goods_number FROM " .$GLOBALS['ecs']->table('cart').
                ...
                " AND parent_id = 0 AND goods_attr = '" .get_goods_attr_info($spec). "' " .
                " AND extension_code <> 'package_buy' " .
				" AND user_id= '".$_SESSION['user_id']."'". //代码增加  By  bbs.ahxcjy.com
 ...
 * @return  boolean
 */
/* 代码修改_start By www.ahxcjy.com  提示：增加了两个参数 */
...
//    }
    ...
    $parent = array(
        ...
        'market_price'  => $package_pricea[0] ? $package_pricea[0] :  $package['market_package'], //修改 by www.ahxcjy.com
        'goods_price'   => $package_pricea[1] ? $package_pricea[1] :  $package['package_price'], //修改 by www.ahxcjy.com
		'package_attr_id' =>$package_attr_id, //增加 by www.ahxcjy.com
        'goods_number'  => $num,
        'goods_attr'    => '',
        'goods_attr_id' => '',
    ...
    if ($num > 0)
    {
        ...
        $sql = "SELECT goods_number FROM " .$GLOBALS['ecs']->table('cart').
                ...
                " AND package_attr_id = '$package_attr_id'  AND rec_type = '" . CART_GENERAL_GOODS . "'";   //修改 by www.ahxcjy.com 增加一条件
