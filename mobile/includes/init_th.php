...
/* 取得当前ecshop所在的根目录 */
define('ROOT_PATH', str_replace('includes/init_th.php', '', str_replace('\\', '/', __FILE__)));
...
$db->set_disable_cache_tables(array($ecs->table('sessions'), $ecs->table('sessions_data'), $ecs->table('cartth')));
...
{
$smarty->template_dir   = ROOT_PATH . 'themesmobile/ahxcgg_mobile';
