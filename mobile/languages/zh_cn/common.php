...
$_LANG['drop_consignee_confirm'] = '您确定要删除该提货人信息吗？';
...
$_LANG['can_use_integral'] = '您的积分';
$_LANG['noworder_can_integral'] = '本订单可用';
...
$_LANG['order_payed_sms'] = '订单 %s 付款了。提货人：%s；电话：%s。';
...
$_LANG['p_y']['link_start'] = '<a href="http://bbs.ahxcjy.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
