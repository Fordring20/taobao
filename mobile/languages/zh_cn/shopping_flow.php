...
$_LANG['no_goods_in_cart'] = '您没有选择需要商品！';
...
/* 提货人信息 */
$_LANG['flow_js']['consignee_not_null'] = '提货人姓名不能为空！';
$_LANG['flow_js']['country_not_null'] = '请您选择提货人所在国家！';
$_LANG['flow_js']['province_not_null'] = '请您选择提货人所在省份！';
$_LANG['flow_js']['city_not_null'] = '请您选择提货人所在城市！';
$_LANG['flow_js']['district_not_null'] = '请您选择提货人所在区域！';
$_LANG['flow_js']['invalid_email'] = '您输入的邮件地址不是一个合法的邮件地址。';
$_LANG['flow_js']['address_not_null'] = '提货人的详细地址不能为空！';
...
$_LANG['new_consignee_address'] = '新提货人地址';
$_LANG['consignee_address'] = '提货人地址';
$_LANG['consignee_name'] = '提 货 人';
...
$_LANG['city'] = '城市';
$_LANG['area'] = '所在区域';
$_LANG['consignee_add'] = '添加新提货地址';
$_LANG['shipping_address'] = '配送至这个地址';
$_LANG['address_amount'] = '您的提货人信息最多只能是三个';
$_LANG['not_fount_consignee'] = '对不起，您选定的提货人不存在。';
$_LANG['must'] = '（必填）';
...
$_LANG['order_placed_sms'] = "您有新订单.提货人:%s 电话:%s";
$_LANG['sms_paid'] = '已付款';
