...
$_LANG['del_address_false'] = '删除提货人失败！';
$_LANG['add_address_success'] = '添加新地址成功！';
$_LANG['edit_address_success'] = '您的提货人信息已成功更新！';
$_LANG['address_list_lnk'] = '返回地址列表';
$_LANG['add_address'] = '新增提货人';
$_LANG['confirm_edit'] = '确认修改';

$_LANG['confirm_drop_address'] = '你确认要删除该提货人吗？';
...
$_LANG['merge_order_notice'] = '订单合并是在发货前将相同状态的订单合并成一新的订单。<br />提货人，提货地址等以主订单为准。';
...
$_LANG['confirm_received'] = '您确认已经收到货物了吗？确认提货后不可再申请退货，请确认收到的货物没有问题。';
...
/* 保存用户订单提货地址 */
$_LANG['consigness_empty'] = '提货人姓名为空';
$_LANG['address_empty'] = '提货地址详情为空';
