...
if (!$smarty->is_cached('goods.dwt', $cache_id))
{
    ...
    $goods['gongyingshang'] = $db->getOne("select suppliers_name from " . $ecs->table('suppliers') . " where suppliers_id='" . $goods['suppliers_id'] . "'");
...
/* 代码增加_end   By www.ahxcjy.com  自提点 */
 ...
 /* 代码增加 By  bbs.ahxcjy.com 自提点 End */
...
$cusqq = $db->getRow("select * from " . $ecs->table('chat_third_customer') . " where cus_type = 0 and is_master = 1 and supplier_id = 0 limit 1");
$smarty->assign('cusqq', $cusqq);
