...
<div style="width: 100%; height: 28px; border-top: 1px solid #CCC;">
    <p style="line-height: 28px; font-size: 12px; color: #FF0000; text-align: center;">今日已团购商品数量 <?php echo $this->_var['shankuan']['count']; ?> 笔，筹得善款 <?php echo $this->_var['shankuan']['amount']; ?> 元</p>
</div>
</section>
...
<?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_54269600_1510017610');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_54269600_1510017610']):
?>
<li <?php if ($this->_var['brand_0_54269600_1510017610']['selected']): ?>class="on"<?php endif; ?>  id="brand_<?php echo $this->_var['brand_0_54269600_1510017610']['brand_id']; ?>"><a href="javascript:get_brand('<?php echo $this->_var['brand_0_54269600_1510017610']['brand_id']; ?>')"><?php echo $this->_var['brand_0_54269600_1510017610']['brand_name']; ?></a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <div class="filtrate_price"onclick="return 1;">
                 ...
                 <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_54285400_1510017610');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_54285400_1510017610']):
        $this->_foreach['filter_attr_list']['iteration']++;
?>  
        <div class="filtrate_category" >
            <a href="javascript:;" class="filtrate_category_a"><?php echo htmlspecialchars($this->_var['filter_attr_0_54285400_1510017610']['filter_attr_name']); ?><?php echo $this->_var['lang']['colon']; ?> <span class="up_down">全部</span></a>
        </div>
        <ul class="clearfix filtrate_address filtrate_list att_item" id="attrs_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
        <?php $_from = $this->_var['filter_attr_0_54285400_1510017610']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');$this->_foreach['filter_attr'] = array('total' => count($_from), 'iteration' => 0);
...
<input type="hidden" id="showahxcgg_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>" name="showahxcgg" value="<?php echo $this->_var['attr']['attr_id']; ?>"/>
<?php endif; ?>
        </li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
...
<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_54356400_1510017610');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_54356400_1510017610']):
        $this->_foreach['filter_attr_list']['iteration']++;
?>
