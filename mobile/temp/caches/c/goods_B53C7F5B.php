<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:68:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/goods.dwt";i:1;s:78:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/library/up_menu.lbi";i:2;s:84:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/library/goods_gallery.lbi";i:3;s:79:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/library/comments.lbi";i:4;s:88:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/library/goods_choose_attr.lbi";i:5;s:84:"D:/xampp/htdocs/aixingou/mobile/themesmobile/ahxcgg_mobile/library/arrive_notice.lbi";}s:7:"expires";i:1510022891;s:8:"maketime";i:1510019291;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width">
<title>aba义卖01_义不容辞_爱心购  </title>
...
<form action="share_goods.php" method="post" id="share_form">
  <input type="hidden" name="content" value="aba义卖01">
  <input type="hidden" name="pics" value="./.././images/1409272951415985699.jpg">
  <input type="hidden" name="gid" value="40">
  <input type="hidden" name="url" value="http://localhost/aixingou/mobile/goods.php?id=40">
</form>
<form action="javascript:addToCart(40)" method="post" id="purchase_form" name="ECS_FORMBUY" >
<input type="hidden" id="chat_goods_id" value="40" />
...
<div class="product_info"> 
  ...
  <dl class="goods_price">
        <dt> <span id="ECS_GOODS_AMOUNT">10</span> 
      <em style="display:none">包邮</em> 
    </dt>
    <dd> <i>价格：<font>12</font></i> 
       
      <em style="display:none">赠送积分: <span id="ECS_GOODS_AMOUNT_JF"></span></em> 
       
      <em id="IS_EXCLUSIVE" style="display:none">手机专享</em> </dd>
        <dd style="float: right; font-size: 12px; color: #999;">供应商：</dd>
  </dl>  
  <ul class="price_dottm">
    <li style=" text-align:left">折扣：8.3折</li>
    <li>0人评价</li>
    <li style=" text-align:right">0人已购</li>
  </ul>
</div>
...
<a href="pocking.php?id=40"><span>查看自提点</span><i><img src="themesmobile/ahxcgg_mobile/images/goods/ziti.png"></i></a>
</section>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:40;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(40,0,1);</script>
      </div>
...
<ul>
 ...
 <li><p>商品名称：</p><span>aba义卖01</span></li>
   <li><p>商品编号：</p><span>xc000026</span></li>     <li><p>上架时间：</p><span>2017-10-14</span></li>   <li><p>商品重量：</p><span>0克</span></li> <li><p>商品库存：</p><span> 缺货 </span></li>
  </ul>
</section>
<div class="goods_shut">
...
function choose_attr(num){
	...
	$(".f_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(40),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('purchase_form');  
            actionForm.action = "javascript:addToCart(40,0,1),close_choose_attr()";
        }
}
...
<div style="background:#FFFDEE ;border:1px dotted #ff3300;line-height:20px; font-weight:normal; padding:10px; margin-top:10px;">
            <p style="font-size:16px;color:#F52648;">aba义卖01</p>
 ...
 <li><input type="button" value="提交" onclick="tell_me1(40)" class="tell_btn"/></li>
 </ul>
  </div>
</div>
<script>
...
"><em class="goods_nav2"></em><span>客服</span></a> </li>
 <li><a href="javascript:collect(40)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl> 
 <dd class="goumai" id="ECS_ONE_STEP_BUY"><a style="display:block;" onClick="choose_attr(1)">立即购买</a> </dd>
 <span class="daohuo" id="ECS_DAOHUO"> <a onClick="tell_me(40)"/>到货通知</a></span>
 </dl>                
</div>  
</body>  
</html>